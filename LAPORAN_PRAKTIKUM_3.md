...
## DAFTAR ISI
- [LAPORAN TUGAS PRAKTIKUM KRIPTOGRAFI PASCA-KUANTUM](#laporan-tugas-praktikum-kriptografi-pasca-kuantum)
  - [MODUL 03: INTEGRASI APLIKASI WEB, API, DAN PUBLIC KEY INFRASTRUCTURE (PKI)](#modul-03-integrasi-aplikasi-web-api-dan-public-key-infrastructure-pki)
  ...
  - [3. Prasyarat dan Spesifikasi Lingkungan Pengujian](#3-prasyarat-dan-spesifikasi-lingkungan-pengujian)
    - [3.1 Prasyarat Modul (Analisis Dependensi)](#31-prasyarat-modul-analisis-dependensi)
    - [3.2 Spesifikasi Testbed](#32-spesifikasi-testbed)
  - [4. Alur Pelaksanaan dan Bukti Eksekusi](#4-alur-pelaksanaan-dan-bukti-eksekusi)
    - [Langkah 1 — Membangun Otoritas Sertifikat (PKI) Pasca-Kuantum](#langkah-1--membangun-otoritas-sertifikat-pki-pasca-kuantum)
      - [Perintah Eksekusi:](#perintah-eksekusi)
      - [Hasil Verifikasi:](#hasil-verifikasi)
      - [Dokumentasi Bukti Eksekusi Langkah 1:](#dokumentasi-bukti-eksekusi-langkah-1)
    - [Langkah 2 — Pengukuran Ukuran Biner (DER) \& Estimasi Anggaran Bandwidth](#langkah-2--pengukuran-ukuran-biner-der--estimasi-anggaran-bandwidth)
      - [Tabel Data Pengukuran Biner DER Nyata:](#tabel-data-pengukuran-biner-der-nyata)
      - [Pemodelan Anggaran Bandwidth Produksi:](#pemodelan-anggaran-bandwidth-produksi)
      - [Dokumentasi Bukti Eksekusi Langkah 2:](#dokumentasi-bukti-eksekusi-langkah-2)
    - [Langkah 3 — Penerapan Server dan Klien TLS 1.3 Pasca-Kuantum Penuh](#langkah-3--penerapan-server-dan-klien-tls-13-pasca-kuantum-penuh)
      - [Perintah Eksekusi:](#perintah-eksekusi-1)
      - [Hasil Verifikasi 3 Baris Kunci:](#hasil-verifikasi-3-baris-kunci)
      - [Dokumentasi Bukti Eksekusi Langkah 3:](#dokumentasi-bukti-eksekusi-langkah-3)
    - [Langkah 4 — Implementasi Mutual TLS (mTLS) Antar-Layanan](#langkah-4--implementasi-mutual-tls-mtls-antar-layanan)
      - [Perintah Eksekusi:](#perintah-eksekusi-2)
      - [Uji Eksperimen:](#uji-eksperimen)
      - [Dokumentasi Bukti Eksekusi Langkah 4:](#dokumentasi-bukti-eksekusi-langkah-4)
    - [Langkah 5 — Analisis Wireshark/tcpdump: Fenomena ClientHello yang Pecah](#langkah-5--analisis-wiresharktcpdump-fenomena-clienthello-yang-pecah)
      - [Hasil Analisis Inspeksi Paket:](#hasil-analisis-inspeksi-paket)
      - [Perbandingan Karakteristik Paket:](#perbandingan-karakteristik-paket)
      - [Analisis Bahaya Fragmentasi MTU 1500 di Dunia Nyata:](#analisis-bahaya-fragmentasi-mtu-1500-di-dunia-nyata)
      - [Dokumentasi Bukti Eksekusi Langkah 5:](#dokumentasi-bukti-eksekusi-langkah-5)
    - [Langkah 6 — Implementasi Gerbang Verifikasi Kriptografi pada CI/CD](#langkah-6--implementasi-gerbang-verifikasi-kriptografi-pada-cicd)
      - [Hasil Uji Gerbang CI:](#hasil-uji-gerbang-ci)
      - [Dokumentasi Bukti Eksekusi Langkah 6:](#dokumentasi-bukti-eksekusi-langkah-6)
